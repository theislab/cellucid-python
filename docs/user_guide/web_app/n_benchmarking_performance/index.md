...
:::{grid-item-card} {octicon}`tools;1.5em;sd-mr-1` Benchmark tools
:link: 05_benchmark_tools
:link-type: doc

How to use the in-app benchmark tools, plus interpretation and common pitfalls.
:::
