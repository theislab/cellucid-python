# Figure export screenshots

This folder is the recommended destination for screenshots used in:
- `cellucid-python/docs/user_guide/web_app/k_figure_export/`
...
3) Redact anything sensitive (local file paths, dataset names/ids if private, repo/org names if private).
