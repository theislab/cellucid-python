...
# Define constants
LOCAL_PATH="/Users/kemalinecik/git_nosync/_"
SERVER_PATH="/home/icb/kemal.inecik/work/codes"
PROJECT_NAME="cellucid-python"
REMOTE_USER="kemal.inecik"
REMOTE_HOST="hpc-build01"
REMOTE_PATH="$SERVER_PATH/$PROJECT_NAME"

EXCLUSIONS=("__pycache__" "*.DS_Store" ".idea" ".mypy_cache" "*.ipynb_checkpoints" ".git" "*_build" "*.virtual_documents" "__temp__" ".pytest_cache")
SYNC_DIRS=()
...
while true; do
    echo ''
    log "Please select an option for *CELLUCID-PYTHON* sync:"
